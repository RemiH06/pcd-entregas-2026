...
def construir_presentacion(
    ...
    print(f"hola mi nombre es {nombre}, estoy en mi semestre {semestre} y mi expectativa es {expectativa}")
    return ""
...
def estimar_duracion(distancia_km: float) -> float:
    ...
    if distancia_km <= 0:
        return ValueError("La distancia debe ser positiva")
...
nombre = "Remi"
semestre = "6to"
expectativa = "espero hacer un gran proyecto"
